...
st.set_page_config(
    page_title="Mundo Geomática - AHP",
...
st.markdown(
    """
    <div style="background-color: #000080; padding: 14px;">
...
with st.form(key='add_variable_form'):
    ...
    new_variable = cols[0].text_input("Digite o nome da nova variável:")
    cols[1].text("")
    cols[1].text("")
...
st.markdown(
    """
    <div style="text-align: center; font-size: 18px; color: #000000; font-family: 'Verdana', sans-serif;">
         <br>
